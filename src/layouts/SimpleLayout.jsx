...
export const SimpleLayout = ({ children }) => {
  ...
  return (
    <div
      className="bg-[#000000] m-0 w-full text-[#F5F5F5] min-h-[100vh] "
     
    >
      <main>
        <div style={{ display: "flex" }} className="">
          <nav className=" fixed  border-[#363636] border rounded ml-0 px-[20px] py-10  bg-[#000000] text-[#F5F5F5]  w-[15%] z-[1px] h-[100vh] top-0">
